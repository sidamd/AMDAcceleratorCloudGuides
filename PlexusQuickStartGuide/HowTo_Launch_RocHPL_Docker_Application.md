...
***
 ...
 11. Once the application execution is successful then the status gets changed into “Completed”.
 ...
 12. The final score in the STDOUT tab is the performance of RocHPL application.
